  ...
  features:
    - title: 快速开发
      ...
      highlights:
        ...
        - title: 现有模板：运行 <code>git clone https://github.com/chengliang4810/jimuqu-docs-docs-template.git</code> 以下载当前文档模板。
  ...
  features: [
    {
      ...
      highlights: [
        ...
        {
          title:
            "现有模板：运行 <code>git clone https://github.com/chengliang4810/jimuqu-docs-docs-template.git</code> 以下载当前文档模板。",
        },
      ],
    },
    {
