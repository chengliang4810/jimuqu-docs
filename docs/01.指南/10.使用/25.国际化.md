...
2. 然后参考 Teek 现有的任一 [语言文件](https://github.com/chengliang4810/jimuqu-docs/tree/master/vitepress-theme-teek/src/locale/lang)，将里面的内容拷贝到 `zh-tw.ts` 文件中，并将所有内容（Value）修改为 `zh-tw` 语言
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      text: "在 GitHub 上编辑此页",
      pattern: "https://github.com/chengliang4810/jimuqu-docs/edit/master/docs/:path",
    },
  },
});
```
